...
# =================================================================
# SAMBA AD DC TELEPÍTŐ SCRIPT - 1.1b
# Citk 2025
# =================================================================
...
echo "================================================================" 
echo "Samba AD DC telepítés - CITK 2025"
echo "1.1b: DNS, Kerberos, NetBIOS javítás"
echo "================================================================" 
...
section_header "SAMBA AD DC TELEPÍTÉS - JAVÍTOTT VERZIÓ"
